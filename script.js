...
function ImgC(){
    const searchInput = document.getElementById("search");
searchInput.value = "Sacs Gucci";
searchInput.dispatchEvent(new Event('input')); // ou 'keyup' selon ton code
}
//localStorage.removeItem('cart');
const produits = [
  { id: 1, nom: "Gourde isotherme", description: "Conserve boisson chaude ou foide.", image: "Gourde1.jpg", prix: 17, reduction: 12, quantite: 0, type : "populaire", categorie:"autres"},
